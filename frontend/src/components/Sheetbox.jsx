...
function Sheetbox() {
  ...
  return (
    <div className="p-6 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
      {sheetlist.length === 0 ? (
        <p className="text-white text-center">No sheets available.</p>
      ) : (
        <select
          className="w-full p-3 bg-gray-800 text-white rounded-md border border-teal-400 focus:outline-none text-sm sm:text-base"
